	...
	public void uploadFile() throws Exception {
		...
		try {
			...
			System.out.println("testcaseid" + testcaseId + ",\nmodule_id" + moduleId + ",\ntestset_id" + testsetId
					+ ",\nuser_id" + userId + ",\nresult" + resultCount + ",\nreportStatus" + Constants.testName);
			new FileUploaderClient().uploadFile(report_upload_url, reportsPath, userId, testcaseId, testsetId, moduleId, subModuleId, is_web, resultCount, Constants.testName, mobile);
